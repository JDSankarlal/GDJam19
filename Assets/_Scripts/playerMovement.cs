...
public class playerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        if (this.gameObject.name == "Player1")
        {
            ...
            localSpeed += Time.deltaTime * acceleration;
            ...
            cc1.Move(move * Time.deltaTime * localSpeed);
        }
        ...
        if (this.gameObject.name == "Player2")
        {
            ...
            cc2.Move(move * Time.deltaTime * localSpeed);
        }
        ...
        if (this.gameObject.name == "Player3")
        {
            ...
            cc3.Move(move * Time.deltaTime * localSpeed);
        }
        ...
        if (this.gameObject.name == "Player4")
        {
            ...
            cc4.Move(move * Time.deltaTime * localSpeed);
        }
